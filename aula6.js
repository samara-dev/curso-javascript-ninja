...
/*
Daclare uma variável chamada 'teams', que receberá um array com 5 elementos.
Os elementos serão nomes de times do campeonato escolhido, e os nomes devem
estar na ordem em que eles aparecem na tabela no momento da solução desse desafio.
*/

var teams = ['Flamengo', 'Botafogo', 'Fluminense', 'Bahia', 'Vasco'];
console.log('Times que estão participando do campeonato: ', teams);

/*
Crie uma função chamada 'showTeamPosition' com as seguintes caracteristicas:
- A função deve retornar um número por parâmetro;
- A função deve retornar a frase:
"O time que está em [POSIÇÃO] lugar é o [NOME DO TIME].";
- Onde [POSIÇÃO] é o valor passado por parâmetro e [NOME DO TIME], é o
time que está nessa posição no array criado acima com os nomes dos times.
---------------------
Dica: lembre-se que arrays começam no índice zero, então a 
posição passada deve ser sempre um número a mais que o índice do array;
---------------------
...
/*
Mostre os números de 20 a 30 no console (inclusive o 30), usando
...
hexadecimal (pode ser qualquer tom);
- Usando a estrutura switch, verifique se a cor passada por parâmetro é
algum hexa escolhido. Se for, retorne a frase:
'O hexadecimal para a cor [COR] é [HEXADECIMAL].';
- Se a cor passada por parâmetro não estiver entre as selecionadas, 
mostre a frase:
